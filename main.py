# Hoàng Mạnh Hùng - 2321050022
# Trần Việt Hoàng - 2321050039
# Đỗ Văn Đạt - 2321050078
...
plt.scatter(df_new['budget'], df_new['gross'], color='darkorange', alpha=0.6)
...
plt.hist(df_new['score'], bins=20, color='blue', alpha=0.7, label='Điểm số')
plt.xlabel('Điểm số')
plt.ylabel('Tần suất')
st.pyplot(fig3)
